...
func profileConfigCommentSpecs(types schemaCommentMySQLTypes) []schemaTableComment {
	return []schemaTableComment{
		...
		},
		{
			...
			Columns: []schemaColumnComment{
				{Name: "profile_id", MySQLType: types.v255, Comment: "Profile identifier for this catalog."},
				{Name: "indexed_at", MySQLType: types.timeType, Comment: "UTC time when the catalog was indexed."},
				{Name: "catalog_json", MySQLType: types.jsonType, Comment: "Full structured profile catalog payload."},
				{Name: "services", MySQLType: types.intType, Comment: "Number of services in the catalog."},
				{Name: "workflows", MySQLType: types.intType, Comment: "Number of workflows in the catalog."},
				{Name: "interface_nodes", MySQLType: types.intType, Comment: "Number of interface nodes in the catalog."},
				{Name: "api_cases", MySQLType: types.intType, Comment: "Number of API cases in the catalog."},
				{Name: "request_templates", MySQLType: types.intType, Comment: "Number of request templates in the catalog."},
				{Name: "workflow_bindings", MySQLType: types.intType, Comment: "Number of workflow bindings in the catalog."},
				{Name: "case_dependencies", MySQLType: types.intType, Comment: "Number of case dependencies in the catalog."},
				{Name: "fixtures", MySQLType: types.intType, Comment: "Number of fixtures in the catalog."},
				{Name: "templates", MySQLType: types.intType, Comment: "Number of templates in the catalog."},
				{Name: "template_configs", MySQLType: types.intType, Comment: "Number of template configs in the catalog."},
			},
		},
	}
}
